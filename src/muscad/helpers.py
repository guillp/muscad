...
def cos(deg: float) -> float:
    """Returns the cosinus of angle in degrees :param deg: an angle, in degrees :return: a cosine, between -1 and 1."""
    return math.cos(math.radians(deg))


def sin(deg: float) -> float:
    """Returns the sinus of an angle in degrees :param deg: an angle, in degrees :return: a sine, between -1 and 1."""
    return math.sin(math.radians(deg))


def tan(deg: float) -> float:
    """Returns the arc tangent of an angle in degrees :param deg: an angle, in degrees :return: an arc tangent."""
    return math.tan(math.radians(deg))


def acos(x: float) -> float:
    """Returns the arc cosine of x, in degrees :param x: a float :return: the arc cosine in degrees."""
...
def atan(x: float) -> float:
    """Returns the arc tangeant of x, in degrees :param x: a float :return: the arc tangent in degrees."""
...
def camel_to_snake(name: str) -> str:
    """Transform a CamelCase name (like Python class names) into a snake_case name (like OpenSCAD object names).
